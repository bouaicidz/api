...
(function () {
  ...
  function K7() {
    ...
    Kv.innerHTML = 'console.group("%cSqueeze Template", "font-weight:bold;color:#d24949;font-family:Tahoma;font-size:18px;");console.log("» Homepage      : https://bouaici-templates.blogspot.com/");console.log("» Designed by   : Ahmad Saleh");console.log("» Programmed by : Muhammad Saleh");console.log("» Version       : 2.3.1");console.groupEnd()';
  ...
  let KK = setInterval(function () {
    ...
    if (_$("#SqIcon").href !== "https://2024rd.blogspot.com/") {
      K9(3);
    }
          ...
          if (!Kj.hasClass("rendered")) {
            ...
            $getJSONP(Kc + "/posts/summary/-/" + Kz + "?alt=json&max-results=10", function (Kv) {
              if (Kv.feed.entry) {
                ...
                K6(function () {
                  var Kb = {direction: BlogDirection};
                  Kb.pagination = false;
                  Kb.perPage = 4;
                  Kb.rewind = true;
        ...
        function Ko(Kn) {
          ...
          if (Kf === "slideshow") {
            ...
            K6(function () {
              ...
              var KH = {type: "fade", rewind: true, direction: BlogDirection, perPage: 1, arrows: false, autoplay: true, pagination: false, resetProgress: false};
  ...
  function KL() {
    ...
    function Kv() {
      ...
      _$(".noimg").each(function (Km) {
        Km.after('<img title="user avatar" alt="user avatar" data-src="https://3.bp.blogspot.com/-zA1pdXqIA3g/WmSZNYYtVMI/AAAAAAAAAAw/hE9ko5Mhh6Q3Rwj3ziWErOuwLjeekF3IwCLcBGAs/s72-c-e90-rw/Unknown.png">');
        Km.remove();
      });
      if (D) {
